...
class MultiScaleBSQ(Module):
    ...
    def forward(
        ...
        ret = (quantized_out, all_indices, all_bit_indices, residual_norm_per_scale, all_losses, var_inputs, quantizeds)
...
class BSQ(Module):
    ...
    def codes_to_bits(self, codes):
        # return bits * self.codebook_scale * 2 - self.codebook_scale
        return codes + self.codebook_scale / (2 * self.codebook_scale)
